...
public class databaseDefine {
	...
	public static void databaseInsert(){
		...
		String[] insert = {
				...
				NAMELIST + "('大口水産ヤキヤキコーナー',36.571249,136.656533,0,900,1700,10001000)",
				NAMELIST + "('井ノ弥',36.571047,136.656246,0,1100,2100,10010000)",
				...
				NAMELIST + "('鮨　歴々',36.570769,136.656205,0,1130,2000,10000000)",
				NAMELIST + "('カフェ・アルコメルカート',36.571488,136.655877,0,1100,2300,10000000)",
