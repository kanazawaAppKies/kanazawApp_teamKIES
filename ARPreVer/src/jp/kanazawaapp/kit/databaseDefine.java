...
public class databaseDefine {
	/**データベースの要素の型*/
	final String  TYPES = "(name,latitude,longitude,genre,open,close,rest)";
	
	/**データベース挿入のテンプレート文*/
	final String NAMELIST ="INSERT INTO namelist"+TYPES+"VALUES";
	
	/** データ名と保存場所を登録*/
    String dbName = "data/data/" + ARPreviewActivity.packageName + "/myDatabase1.db";
    ...
    /**データベースにデータを追加*/
	void databaseInsert(Context context){
		String[] insert = {
